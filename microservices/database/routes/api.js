...
router.get('/user/:mail',  async (req, res) => {
  ...
  const span = createSpan('get-user-by-mail', {
...
router.post('/user/add',  async (req, res) => {
  ...
  const span = createSpan('add-user', {
    attributes: req.body
  });
...
router.get('/court/all/:date', async (req, res) => {
  ...
  const span = createSpan('get-court-by-date', {
...
router.get('/court/reservation/:date/:id',  async (req, res) => {
  ...
  const span = createSpan('get-reservations-by-date-and-id', {
